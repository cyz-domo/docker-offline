...
function blueTheme(html) {
  ...
  const cleaned = styled.replace("</head>", "<style>.hero-note,.retention,.foot{display:none!important}</style></head>");
  let withControl = cleaned.replace('<div id="result"></div>', `${control}<div id="result"></div>`);
